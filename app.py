...
QUIZ_DATA = [
    ...
    {"q": "3. 환불받을 수도 없는 과거의 노력에 얽매인 의사결정을 하게 만드는 것은?", "a": "매몰비용"},
    {"q": "4. 성공적인 투자의 대가는 변동성, (_________), 의심, 불확실성, 후회로 지불해야 한다.", "a": "공포"},
    {"q": "5. 모건 하우절은, 시장 변동성을 벌금이 아니라, (___________)라고 생각하자라고 제안한다.", "a": "수수료"},
    {"q": "6. 모건 하우절은, 거품이 피해를 주는 것은 (________)투자자들이 자신들과는 다른 게임을 하는 (________)거래자들로부터 신호를 읽기 시작할 때라고 주장한다.", "a": "장기, 단기"},
    {"q": "7. (________________)은 자신의 능력을 과대평가하거나, 자신이 어떤 것을 예측할 때 실수할 확률이 적다고 믿는 성향이다.", "a": "자기과신"}
]
