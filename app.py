...
QUIZ_DATA = [
    ...
    {"q": "2. 3M 모델은 미래 지향적 행동을 이해하는 데 유용하여 (_________) 재무 계획이나 저축 행태 연구에 적합하다.", "a": "은퇴"},
    {"q": "3. MBTI에서 사고형(T)은 의사결정을 내릴 때 (___________)이고 이성적이다.", "a": "논리적"},
    {"q": "4. MBTI와 투자 행태 연구에서 상반된 결과가 나오는 이유는, 연구 샘플의 (____________) 차이 때문으로 해석된다.", "a": "문화적"},
    {"q": "5. Gakhar and Prakash (2017)에 따르면, 감정(F) 유형일수록 본인의 판단을 지나치게 믿는 과잉 확신 편향이 (__________) 나타난다. (많게/적게 중에서 하나를 적으세요)", "a": "적게"},
    {"q": "6. MBTI가 투자성향을 ‘결정’하는 검사라는 주장은 (_____________). (적절하다/적절하지 않다 중에서 하나를 적으세요)", "a": "적절하지 않다"},
    {"q": "7. BIT(Behavioral Investor Types) 모델에서 “트렌드는 놓칠 수 없지! 친절한 유행 선도자”에 해당하는 유형은? (한글만 적으세요)", "a": "추종자"}
]
