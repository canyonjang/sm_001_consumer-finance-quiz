...
QUIZ_DATA = [
    ...
    {"q": "2. 미국의 한 연구에 따르면, 유동성 비율과 (______________)이 높을수록, 부채비율이 낮을수록 재무적 웰빙 수준이 높아진다.", "a": "투자비율"},
    {"q": "3. 사회초년생 필수 계좌 3가지는 CMA, (________), 연금저축 등이다.", "a": "ISA"},
    {"q": "4. Confounding Compounding은 (__________)의 놀라운 힘을 사람들이 제대로 이해하지 못하는 현상이다.", "a": "복리"},
    {"q": "5. (________)부자의 롤모델은 찾기 쉽지만, (________)부자의 롤모델은 찾기가 어렵다.", "a": "소비, 자산"},
    {"q": "6. 부를 쌓는 것은 소득, 투자수익률과 거의 관계가 없고, (__________)과 관계가 깊다.", "a": "저축률"},
