...
QUIZ_DATA = [
    ...
    {"q": "2. 이슈2의 입장B의 논리에 따르면, 플랫폼 권력은 끝없이 비교를 유도하며 무엇을 자아실현으로 착각하게 만드나?", "a": "소비"},
    {"q": "3. 어느 조직에서 목표가 구체적일 때, 다소 어렵더라도 달성가능할 때, 마감시한이 있을 때 가장 좋은 성과가 난다고 설명하는 이론은?", "a": "목표설정이론"},
    {"q": "4. 자녀교육과 재산형성이 주요 재무이슈인 생애주기는?", "a": "자녀 성장기"},
    {"q": "5. 나와 가족의 인생에서 목돈이 필요한 중요 이벤트가 몇 살에 생길지를 미리 예상해 보기 위한 표는?", "a": "생애설계연표"},
    {"q": "6. 현재 가지고 있는 자산 부채의 종류와 규모를 파악하기 위한 표는?", "a": "자산부채 상태표"},
    {"q": "7. 매월 평균적인 수입과 지출 상황을 파악하는 표는?", "a": "현금흐름표"}
]
